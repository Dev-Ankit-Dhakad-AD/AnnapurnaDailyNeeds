        ...
        <div className="container nav-container">
          ...
          <div className="nav-links">
            ...
            <div className="nav-actions">
              <a href="https://annapurnadailyneedsshivpuri.vercel.app/" target="_blank" rel="noopener noreferrer" className="nav-btn nav-btn-outline">
                <Globe size={18} />
          ...
          <div className={`mobile-menu ${menuOpen ? 'mobile-menu--open' : ''}`}>
            ...
            <div className="mobile-menu-actions">
              <a href="https://annapurnadailyneedsshivpuri.vercel.app/" target="_blank" rel="noopener noreferrer" className="mobile-link mobile-link--btn mobile-link--btn-outline" onClick={closeMenu}>
                <Globe size={16} />
                <span>Use on Web</span>
              </a>
